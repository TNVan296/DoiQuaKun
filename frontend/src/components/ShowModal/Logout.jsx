        ...
        <div className="modal-form text-center px-3 mt-4">
          ...
          <div className="form flex gap-4 p-0 justify-between mt-5 mb-0">
            <button
              type="submit"
              onClick={logOutUser}
              className="onboarding_button_2 text-white bg-[#dc3545] w-[150px] mx-auto mt-0 transition-transform duration-300 ease-in-out transform hover:scale-105 active:scale-95"
            >
              Xác nhận
            </button>
            <button
              onClick={handleClose}
              type="submit"
              className="onboarding_button_2 text-black bg-[#fff] w-[150px] mx-auto mt-0 transition-transform duration-300 ease-in-out transform hover:scale-105 active:scale-95"
            >
              Đóng
            </button>
          </div>
