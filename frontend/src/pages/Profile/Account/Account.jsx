        ...
        <div className="info_col w-3/5 flex flex-col">
          ...
          <div className="info_content">
            <div className="info_title">
              <h1 className='text-black'>Tài khoản của tôi</h1>
              <p>Quản lý thông tin hồ sơ để bảo mật tài khoản</p>
            </div>
            <form className='info_form'>
              <div className="form_group">
                <label htmlFor="name" className='w-1/5 p-2'>Tên</label>
                <input type="text" id="name" className='w-4/5 form_control focus:outline-none focus:border-[#00AAEC] focus:border-[3px]' />
              </div>
              <div className="form_group">
                <label htmlFor="email" className='w-1/5 p-2'>Email</label>
                <input type="text" id="email" className='w-4/5 form_control focus:outline-none focus:border-[#00AAEC] focus:border-[3px]' />
              </div>
              <div className="form_group">
                <label htmlFor="phone" className='w-1/5 p-2'>Số điện thoại</label>
                <input type="tel" value={'0935542939'} id="phone" disabled className='w-4/5 form_control' />
              </div>
              <div className="form_group">
              ...
              <div className="form_group">
                ...
                <input type="text" id="address" className='w-4/5 form_control' />
              </div>
              <div className="form_group">
                <label htmlFor="city" className='w-1/5 p-2'>Tỉnh/Thành phố</label>
                <select id="city" className='w-4/5 form_control focus:outline-none focus:border-[#00AAEC] focus:border-[3px]'>
              ...
              <div className="form_group">
                ...
                <select id="district" className='w-4/5 form_control focus:outline-none focus:border-[#00AAEC] focus:border-[3px]'>
              ...
              <div className="form_group">
                ...
                <select id="ward" className='w-4/5 form_control focus:outline-none focus:border-[#00AAEC] focus:border-[3px]'>
              ...
              <button type="submit" className="form_button text-white bg-[#00AAEC] w-[200px] mx-auto my-10">Lưu Thông Tin</button>
            </form>
          </div>
        </div>
      </div>
